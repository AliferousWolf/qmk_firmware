 ...
 */
    [_NAV] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, KC_SCRL, _______, _______, _______,KC_PAUSE, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_PSCR,
...
static void render_luna(int LUNA_X, int LUNA_Y) {
    ...
    void animate_luna(void) {
        ...
        /* current status */
        if (mods & MOD_MASK_SHIFT || led_usb_state.caps_lock) {
